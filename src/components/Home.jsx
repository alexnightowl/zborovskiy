    ...
    return (
        guest ? (
            <div className="home">
                ...
                <div className="elips">
                    <p className="text">
                        з радістю запрошуємо {guest?.plural ? "вас" : "тебе"} на одну з найважливіших подій у нашому
                        житті –
                ...
                <div className="elips">
                    <p className="text">
                        Дуже прикро, що така радісна подія відбувається в такий похмурий час, але ми будемо дуже
                        вдячні якщо
                        {guest?.plural ? " ви " : " ти "}
        ...
        ) : <p>Вибачте, але здається ваше посилання пошкоджено, зверніться до організаторів... :(</p>
    );
};
